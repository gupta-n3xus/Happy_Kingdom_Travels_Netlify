  ...
  const faqs = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: `Yes. ${BUSINESS_CONTACT.companyName} can arrange pickup from NJP Railway Station or Bagdogra Airport for applicable Bhutan packages. You can provide your train or flight details while making your enquiry so that we can plan the pickup and onward transfer accordingly.`,
        },
        {
        ...
        {
          q: `How can I book my Bhutan tour with ${BUSINESS_CONTACT.companyName}?`,
        ...
        },
        {
          ...
          a: `Yes. You can contact ${BUSINESS_CONTACT.companyName} through WhatsApp and provide your travel city, travel dates, number of adults, number of children, preferred duration, preferred hotel category, and private/shared preference. Our team can use these details to prepare a suitable Bhutan tour quotation.`,
        },
      ],
    },
    {
    ...
    {
      category: `Why ${BUSINESS_CONTACT.companyName}`,
      items: [
        {
          q: `Why should I book my Bhutan trip with ${BUSINESS_CONTACT.companyName}?`,
        ...
        },
        {
          ...
          a: `Yes. For applicable packages, ${BUSINESS_CONTACT.companyName} can coordinate the Bhutan travel experience from the designated pickup point, including Pickup, Border/Entry Formalities, Bhutan Transportation, Hotels, Sightseeing, and Return Transfer. The exact services included will depend on your selected package.`,
        },
        {
      ...
      <section className="py-16 bg-warmWhite">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-muted text-center mb-12 max-w-2xl mx-auto">
            ...
            questions travellers ask before booking a Bhutan tour with {BUSINESS_CONTACT.companyName}.
          </p>
          ...
          <div className="mt-12 bg-white rounded-2xl p-8 shadow-sm text-center">
            ...
            <p className="text-muted mb-6">
              ...
              question here, contact {BUSINESS_CONTACT.companyName} and our team will help you plan your
              Bhutan journey.
            </p>
            <a
              href={createWhatsAppUrl(createGuideMessage('Bhutan FAQs', BUSINESS_CONTACT.companyName))}
              target="_blank"
